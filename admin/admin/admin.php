...
<!DOCTYPE HTML>
	...
	<head>
		...
		<title>Panel administracyjny • Bumex | Machines with passion</title>
	...
	<body>
		<div id="page">
			<div id="wrapper">
				...
				<div id="main">
					<div class="przyciski">
                        <a href="categoryadd/">Dodaj kategorię</a>
                        <a href="categoryremove/">Usuń kategorię</a>
                        <a href="productadd/">Dodaj produkt</a>
                        <a href="productremove/">Usuń produkt</a>
                        <a href="productedit/">Edytuj produkt</a>
                        <a href="logout.php" class="wyloguj">Wyloguj się</a>
                    </div>
				</div>
				<div id="footer">
						<div id="top-footer">
